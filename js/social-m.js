    ...
    function init() {
        var body = document.getElementsByTagName('body')[0],
            ...
            createElement = function () {
                ...
                var facebook_text = document.createElement('span');
                facebook_text.innerHTML = 'Facebook';
                facebook.appendChild(facebook_text);

                var google = document.createElement('button');
                google.className = 'social google';
                var google_text = document.createElement('span');
                google_text.innerHTML = 'Google';
                google.appendChild(google_text);

                var vk = document.createElement('button');
                vk.className = 'social vk';
                var vk_text = document.createElement('span');
                vk_text.innerHTML = 'Вконтакте';
                vk.appendChild(vk_text);

                var lanet = document.createElement('button');
                lanet.className = 'social lanet';
                var lanet_text = document.createElement('span');
                lanet_text.innerHTML = 'Ланет';
                lanet.appendChild(lanet_text);

                main.appendChild(facebook);
                main.appendChild(google);
                main.appendChild(vk);
                main.appendChild(lanet);
